...
static const char* CAN[] = {"Canh", "Tân", "Nhâm", "Quý", "Giáp", "Ất", "Bính", "Đinh", "Mậu", "Kỷ"};
static const char* CHI[] = {"Thân", "Dậu", "Tuất", "Hợi", "Tý", "Sửu", "Dần", "Mão", "Thìn", "Tỵ", "Ngọ", "Mùi"};

const char* getLunarYearName(int lunarYear) {
    static char buf[32];
    int canIdx = (lunarYear % 10 + 10) % 10;
    int chiIdx = (lunarYear % 12 + 12) % 12;
